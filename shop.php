...
<body>
			...
			<div class="header_agileits">
				...
				<div id="cd-search" class="cd-search">
					<form autocomplete="off">
						<input name="Search" id="input" type="search" placeholder="Click enter after typing...">
						<ul class="list"></ul>
					</form>
				</div>
				<div class="top-nav-header">
					<div class="btn">
						<span class="fas fa-bars pos"></span>
					</div>
					<!-- cart details -->
					<div class="top_nav_right">
						<div class="shoecart shoecart2 cart cart">
			...
			<div class="left-ads-display col-md-9">
				<div class="wrapper_top_shop">
					...
					<div class="product-sec1">
                    	...
                    	?>
						<div class="col-md-4 mt-13 product-men">
											...
											<div class="grid_meta">
												<div class="product_price">
													<div class="grid-price ">
														<span class="money ">$<?= $row['price'] ?>.00</span>
													</div>
												</div>
												<ul class="stars">
	...
	<!-- js -->
	<script type="text/javascript" src="https://cdn.fchat.vn/assets/embed/webchat.js?id=63e38c2107980829984f44c4" async="async"></script>
	...
	<script>
		...
		$('.a-btn').click(function () {
			$('.a-show').toggleClass("show");
			$('.a-btn .first').toggleClass("rotate");
		});
		$('.a1-btn').click(function () {
			$('.a1-show').toggleClass("show");
			$('.a1-btn .first').toggleClass("rotate");
		});
